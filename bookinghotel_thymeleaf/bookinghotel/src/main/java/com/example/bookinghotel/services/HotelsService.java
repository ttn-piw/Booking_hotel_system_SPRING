...
import com.example.bookinghotel.exception.HotelNotFoundException;
...
public class HotelsService {
    ...
    public hotel getHotelByHID(Integer hotelID) {
        hotel hotelResult = hotelRepository.findById(hotelID)
                .orElseThrow(() -> new HotelNotFoundException("Hotel id not found with id: " + hotelID));
