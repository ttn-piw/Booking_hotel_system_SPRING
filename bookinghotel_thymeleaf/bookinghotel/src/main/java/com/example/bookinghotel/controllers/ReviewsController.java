...
public class ReviewsController {
    ...
    @GetMapping("/testAPI")
    @ResponseBody
    public ResponseEntity<List<Map<String,Object>>> getNewAPIReviews() {
        return ResponseEntity.ok(reviewsService.getReviewsServiceJSON());
    }
...
//    }
    @GetMapping("/roomId")
    @ResponseBody
    public ResponseEntity<List<Map<String, Object>>> getReviewsByRoomId(@RequestParam int roomId) {
        return ResponseEntity.ok(reviewsService.getReviewsByRID(roomId));
    }
