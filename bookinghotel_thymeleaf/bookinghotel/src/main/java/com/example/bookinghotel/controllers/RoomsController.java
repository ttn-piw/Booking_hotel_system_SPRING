...
public class RoomsController {
    ...
    @ResponseBody
    public List<room> getRoomsByHotel(@PathVariable("hid") Integer hotelId) {
        return roomsService.getRoomsByHID_api(hotelId);
    }
//    @GetMapping("/hotelId/{hotel_id}")
//    @ResponseBody
//    public List<room> getRoomsByHotelID(@PathVariable("hotel_id") Integer hotelId) {
//        return roomsService.getRoomsByHID(hotelId);
//    }
